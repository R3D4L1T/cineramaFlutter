...
class VideoCar18 extends StatefulWidget {
  const VideoCar18({super.key});

  @override
  State<VideoCar18> createState() => _VideoCar18State();
}

class _VideoCar18State extends State<VideoCar18> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: YoutubePlayer.convertUrlToId(
          'https://www.youtube.com/watch?v=AI3r_sUe2iI')!,
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) => Butacas(
                        pelicula: 'A través de tu mirada',
