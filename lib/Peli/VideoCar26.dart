...
class VideoCar26 extends StatefulWidget {
  const VideoCar26({super.key});

  @override
  State<VideoCar26> createState() => _VideoCar26State();
}

class _VideoCar26State extends State<VideoCar26> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: YoutubePlayer.convertUrlToId(
          'https://www.youtube.com/watch?v=K5NcF1E0lcQ')!,
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'En una remota granja, un padre y sus hijos gemelos se enfrentan a una noche de horror inimaginable, acosados por criaturas salvajes y despiadadas. Unidos por la desesperación, deberán luchar contra el terror y sobrevivir a toda costa.',
