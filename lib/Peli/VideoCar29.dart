...
class VideoCar29 extends StatefulWidget {
  const VideoCar29({super.key});

  @override
  State<VideoCar29> createState() => _VideoCar29State();
}

class _VideoCar29State extends State<VideoCar29> {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'Una joven escritora y su profesor se ven enredados en una compleja red en la que las líneas son borrosas y sus vidas se entretejen.',
