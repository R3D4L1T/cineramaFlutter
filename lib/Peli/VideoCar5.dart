...
class VideoCar5 extends StatefulWidget {
  const VideoCar5({super.key});

  @override
  State<VideoCar5> createState() => _VideoCar5State();
}

class _VideoCar5State extends State<VideoCar5> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: YoutubePlayer.convertUrlToId(
          'https://www.youtube.com/watch?v=T_RJFveZBdI')!,
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'The Conjuring: Last Rites es una próxima película de terror sobrenatural estadounidense de 2025, cuyo guion está siendo escrito por David Leslie Johnson-McGoldrick.',
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) => Butacas(
                        pelicula: 'he Conjuring: Last Rites',
