...
class VideoCar20 extends StatefulWidget {
  const VideoCar20({super.key});

  @override
  State<VideoCar20> createState() => _VideoCar20State();
}

class _VideoCar20State extends State<VideoCar20> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: YoutubePlayer.convertUrlToId(
          'https://www.youtube.com/watch?v=37lX2NUtOpk')!,
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'En La Noche del Demonio: La Puerta Roja, el elenco original de la franquicia de terror vuelve para el último capítulo de la aterradora saga de la familia Lambert, con Patrick Wilson (haciendo su debut como director) Ty Simpkins, Rose Byrne y Andrew Astor.',
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) => Butacas(
                        pelicula: 'La noche del demonio 6',
