...
class VideoCar7 extends StatefulWidget {
  const VideoCar7({super.key});

  @override
  State<VideoCar7> createState() => _VideoCar7State();
}

class _VideoCar7State extends State<VideoCar7> {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'My Hero Academia es un manga escrito e ilustrado por Kōhei Horikoshi. Se basa en un one-shot realizado por el mismo autor y publicado en el quinto volumen del manga Ōmagadoki Dōbutsuen bajo el nombre de My Hero',
