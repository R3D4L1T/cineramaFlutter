...
class VideoCar28 extends StatefulWidget {
  const VideoCar28({super.key});

  @override
  State<VideoCar28> createState() => _VideoCar28State();
}

class _VideoCar28State extends State<VideoCar28> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: YoutubePlayer.convertUrlToId(
          'https://www.youtube.com/watch?v=-TvToOcv0AY')!,
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'El conde de Montecristo es una novela de aventuras clásica de Alejandro Dumas, con la colaboración de Auguste Maquet.​ Esta obra es considerada como la mejor obra literaria de Dumas y está a menudo integrada en toda nómina de novela de aventuras.',
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) => Butacas(
                        pelicula: 'El conde de montecristo',
