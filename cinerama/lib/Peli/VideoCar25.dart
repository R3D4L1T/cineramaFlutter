...
class VideoCar25 extends StatefulWidget {
  const VideoCar25({super.key});

  @override
  State<VideoCar25> createState() => _VideoCar25State();
}

class _VideoCar25State extends State<VideoCar25> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: YoutubePlayer.convertUrlToId(
          'https://www.youtube.com/watch?v=8KXy_GZZKLA')!,
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'Los agentes Mike Lowrey y Marcus Burnett intentan limpiar la reputación de su jefe, a quien han acusado de trabajar para un cartel de narcotraficantes.',
