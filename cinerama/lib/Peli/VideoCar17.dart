...
class VideoCar17 extends StatefulWidget {
  const VideoCar17({super.key});

  @override
  State<VideoCar17> createState() => _VideoCar17State();
}

class _VideoCar17State extends State<VideoCar17> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: YoutubePlayer.convertUrlToId(
          'https://www.youtube.com/watch?v=qPehIc6J3ZQ')!,
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'Veinte años después de haber protagonizado un romance que conquistó los medios de comunicación, un matrimonio se ve superado por la situación cuando una actriz de Hollywood los entrevista como parte de la preparación de una película.',
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) => Butacas(
                        pelicula: 'Secretos de un escándalo',
