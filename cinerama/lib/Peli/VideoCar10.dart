...
class VideoCar10 extends StatefulWidget {
  const VideoCar10({super.key});

  @override
  State<VideoCar10> createState() => _VideoCar10State();
}

class _VideoCar10State extends State<VideoCar10> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: YoutubePlayer.convertUrlToId(
          'https://www.youtube.com/watch?v=vuJA7sqo7y0')!,
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'Tron: Ares es una próxima película estadounidense de ciencia ficción producida por Walt Disney Pictures y distribuida por Walt Disney Studios Motion Pictures. Sirve como secuela independiente de Tron y Tron: Legacy.',
