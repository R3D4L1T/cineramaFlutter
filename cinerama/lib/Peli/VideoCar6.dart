...
class VideoCar6 extends StatefulWidget {
  const VideoCar6({super.key});

  @override
  State<VideoCar6> createState() => _VideoCar6State();
}

class _VideoCar6State extends State<VideoCar6> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: YoutubePlayer.convertUrlToId(
          'https://www.youtube.com/watch?v=kNbrtADNNew')!,
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) => Butacas(
                        pelicula: 'Venom: El último baile',
