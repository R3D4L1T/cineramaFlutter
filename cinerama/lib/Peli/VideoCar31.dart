...
class VideoCar31 extends StatefulWidget {
  const VideoCar31({super.key});

  @override
  State<VideoCar31> createState() => _VideoCar31State();
}

class _VideoCar31State extends State<VideoCar31> {
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) => Butacas(
                        pelicula: 'Avatar la leyenda de aang',
