...
class VideoCar35 extends StatefulWidget {
  const VideoCar35({super.key});

  @override
  State<VideoCar35> createState() => _VideoCar35State();
}

class _VideoCar35State extends State<VideoCar35> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: YoutubePlayer.convertUrlToId(
          'https://www.youtube.com/watch?v=VD8A5hejP5M')!,
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'El camino de un samurái se cruza con el de una mesera cuyo pueblo natal fue destruido por un dragón.',
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) => Butacas(
                        pelicula: 'Monsters: El infierno del dragón',
