...
class VideoCar24 extends StatefulWidget {
  const VideoCar24({super.key});

  @override
  State<VideoCar24> createState() => _VideoCar24State();
}

class _VideoCar24State extends State<VideoCar24> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: YoutubePlayer.convertUrlToId(
          'https://www.youtube.com/watch?v=irmQWB1nitI')!,
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'Adam Clay se embarca en la misión de matar a los estafadores que provocaron que su casera se suicidara tras robarle dinero para la beneficencia. Verona, la hija de la casera y agente del FBI, sospecha que el enigmático Adam no es quien asegura ser.',
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) => Butacas(
                        pelicula: 'Beekeeper: sentencia de muerte',
