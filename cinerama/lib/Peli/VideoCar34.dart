...
class VideoCar34 extends StatefulWidget {
  const VideoCar34({super.key});

  @override
  State<VideoCar34> createState() => _VideoCar34State();
}

class _VideoCar34State extends State<VideoCar34> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: YoutubePlayer.convertUrlToId(
          'https://www.youtube.com/watch?v=9Mo3FL6GmxE')!,
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'Jakub Procházka fue criado por sus abuelos en la campiña checa tras ser abandonado de pequeño. Trabajó como científico antes de intentar convertirse en el primer astronauta de la República Checa.',
