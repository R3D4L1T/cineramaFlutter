...
class VideoCar27 extends StatefulWidget {
  const VideoCar27({super.key});

  @override
  State<VideoCar27> createState() => _VideoCar27State();
}

class _VideoCar27State extends State<VideoCar27> {
  ...
  void initState() {
    ...
    _youtubeController = YoutubePlayerController(
      initialVideoId: YoutubePlayer.convertUrlToId(
          'https://www.youtube.com/watch?v=gY_mgZqumNM')!,
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'Soléne, una mamá soltera de 40 años, comienza un inesperado romance con el joven de 24 años Hayes Campbell, el vocalista principal de August Moon, la boy band más famosa del planeta.',
